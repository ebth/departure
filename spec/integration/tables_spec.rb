...
describe Departure, integration: true do
  ...
  context 'renaming a table' do
    ...
    before do
      ActiveRecord::MigrationContext.new(migration_paths, schema_migration).run(direction, 1)
      ActiveRecord::MigrationContext.new(migration_paths, schema_migration).run(direction, 2)
    end
